...
async def sign_up(request: Request):
    ...
    return web_config.templates.TemplateResponse("index.html", {"request": request, "data": data})
...
#         "title": "Sign up"
#     }
#     return web_config.templates.TemplateResponse("signup.html", {"request": request, "data": data})
...
async def sign_up(request: Request):
    ...
    return web_config.templates.TemplateResponse("login.html", {"request": request, "data": data})
